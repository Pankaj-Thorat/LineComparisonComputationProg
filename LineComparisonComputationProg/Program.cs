...
namespace LineComparisonComputationProg
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // To alculate the length of line 1 and line 2 using the distance formula
            ...
            // To compare the end points of line 1 and line 2
            if ((x1_l1 == x1_l2 && y1_l1 == y1_l2 && x2_l1 == x2_l2 && y2_l1 == y2_l2) || (x1_l1 == x2_l2 && y1_l1 == y2_l2 && x2_l1 == x1_l2 && y2_l1 == y1_l2))
            {
